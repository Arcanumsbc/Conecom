...
var _hero = require("./modules/hero/hero.js");
var _card = require("./modules/advatages/card.js");
var _sliderAdvantages = require("./modules/advatages/sliderAdvantages");
var _sliderGloablPlayer = require("./modules/global-player/sliderGloablPlayer");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _hero.initHero)();
    (0, _card.initializeCards)();
    (0, _sliderAdvantages.initAdvantagesSlider)();
    (0, _sliderGloablPlayer.initGlobalPlayerSlider)();
  });
});
...
},{"./modules/advatages/card.js":2,"./modules/advatages/sliderAdvantages":3,"./modules/global-player/sliderGloablPlayer":4,"./modules/hero/hero.js":5,"./utils/ios-vh-fix":8,"./utils/scroll-lock":10,"./vendor/focus-visible-polyfill":11}],2:[function(require,module,exports){
"use strict";
...
var initAdvantagesSlider = exports.initAdvantagesSlider = function initAdvantagesSlider() {
  ...
  var advantagesSlider = new _swiper.default(advantagesContainer, {
    // cssMode: true,
...
},{"../../utils/is-mobile":9,"../../vendor/swiper":12}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initGlobalPlayerSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
var _isMobile = require("../../utils/is-mobile.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
var initGlobalPlayerSlider = exports.initGlobalPlayerSlider = function initGlobalPlayerSlider() {
  var globalPlayerContainer = document.querySelector('.global-player__wrapper');
  var globalPlayerControl = document.querySelector('.global-player__arrows');
  globalPlayerControl.removeAttribute('data-nojs');
  var globalPlayerSlider = new _swiper.default(globalPlayerContainer, {
    // cssMode: true,
    allowTouchMove: (0, _isMobile.isMobile)(),
    slidesPerView: 'auto',
    observer: true,
...
},{"../../utils/is-mobile.js":9,"../../vendor/swiper.js":12}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initHero = void 0;
var _video = require("./video.js");
// import {initAudioPlayer, stopAudioPlayer} from './audio.js';

// const heroSliderPagination = document.querySelector('.hero__control');

var initHero = exports.initHero = function initHero() {
  // initAudioPlayer();
...
var heroMediaPrew = document.querySelector('[data-prew]');
var button = document.querySelector('.video__button');
var iconYt = document.querySelector('.hero__media-watch-yt');
var iconShare = document.querySelector('.hero__media-share');
var iconWatch = document.querySelector('.hero__media-watch');
var iframe = document.createElement('iframe');
var initVideoPlayer = exports.initVideoPlayer = function initVideoPlayer() {
  button.addEventListener('click', function () {
...
},{"./ios-checker":7}],11:[function(require,module,exports){
"use strict";
